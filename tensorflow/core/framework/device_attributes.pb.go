...
func (*InterconnectLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_fa734a4f52368520, []int{0}
}
...
func (*LocalLinks) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_fa734a4f52368520, []int{1}
}
...
func (*DeviceLocality) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_fa734a4f52368520, []int{2}
}
...
func (*DeviceAttributes) Descriptor() ([]byte, []int) {
	return fileDescriptor_device_attributes_fa734a4f52368520, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/device_attributes.proto", fileDescriptor_device_attributes_fa734a4f52368520)
}

var fileDescriptor_device_attributes_fa734a4f52368520 = []byte{
