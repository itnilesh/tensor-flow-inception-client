...
func (*ResourceHandleProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_handle_79a914553709eafb, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/resource_handle.proto", fileDescriptor_resource_handle_79a914553709eafb)
}

var fileDescriptor_resource_handle_79a914553709eafb = []byte{
