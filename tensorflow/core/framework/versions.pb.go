...
func (*VersionDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_versions_d3b2759f1afcb460, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/versions.proto", fileDescriptor_versions_d3b2759f1afcb460)
}

var fileDescriptor_versions_d3b2759f1afcb460 = []byte{
