...
func (*NodeDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_def_38f56f514677e2a4, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/node_def.proto", fileDescriptor_node_def_38f56f514677e2a4)
}

var fileDescriptor_node_def_38f56f514677e2a4 = []byte{
