...
func (*TensorDescription) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_description_6a5c318673869c64, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_description.proto", fileDescriptor_tensor_description_6a5c318673869c64)
}

var fileDescriptor_tensor_description_6a5c318673869c64 = []byte{
