...
func (*VariableDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_variable_47c58aa1f431a951, []int{0}
}
...
func (*SaveSliceInfoDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_variable_47c58aa1f431a951, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/variable.proto", fileDescriptor_variable_47c58aa1f431a951)
}

var fileDescriptor_variable_47c58aa1f431a951 = []byte{
