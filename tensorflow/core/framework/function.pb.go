...
func (*FunctionDefLibrary) Descriptor() ([]byte, []int) {
	return fileDescriptor_function_28eccb79a13e6a80, []int{0}
}
...
func (*FunctionDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_function_28eccb79a13e6a80, []int{1}
}
...
func (*GradientDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_function_28eccb79a13e6a80, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/function.proto", fileDescriptor_function_28eccb79a13e6a80)
}

var fileDescriptor_function_28eccb79a13e6a80 = []byte{
