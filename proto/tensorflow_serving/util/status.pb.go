...
import fmt "fmt"
import math "math"
import core "github.com/itnilesh/tensor-flow-inception-client/proto/tensorflow/core/lib/core"
...
func (*StatusProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_status_f5f53e497c75d4dd, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/util/status.proto", fileDescriptor_status_f5f53e497c75d4dd)
}

var fileDescriptor_status_f5f53e497c75d4dd = []byte{
