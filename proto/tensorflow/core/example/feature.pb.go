...
func (*BytesList) Descriptor() ([]byte, []int) {
	return fileDescriptor_feature_f23d1f80f3195b44, []int{0}
}
...
func (*FloatList) Descriptor() ([]byte, []int) {
	return fileDescriptor_feature_f23d1f80f3195b44, []int{1}
}
...
func (*Int64List) Descriptor() ([]byte, []int) {
	return fileDescriptor_feature_f23d1f80f3195b44, []int{2}
}
...
func (*Feature) Descriptor() ([]byte, []int) {
	return fileDescriptor_feature_f23d1f80f3195b44, []int{3}
}
...
func (*Features) Descriptor() ([]byte, []int) {
	return fileDescriptor_feature_f23d1f80f3195b44, []int{4}
}
...
func (*FeatureList) Descriptor() ([]byte, []int) {
	return fileDescriptor_feature_f23d1f80f3195b44, []int{5}
}
...
func (*FeatureLists) Descriptor() ([]byte, []int) {
	return fileDescriptor_feature_f23d1f80f3195b44, []int{6}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/example/feature.proto", fileDescriptor_feature_f23d1f80f3195b44)
}

var fileDescriptor_feature_f23d1f80f3195b44 = []byte{
