...
func (*VarLenFeatureProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_062c9db71589bcea, []int{0}
}
...
func (*FixedLenFeatureProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_062c9db71589bcea, []int{1}
}
...
func (*FeatureConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_062c9db71589bcea, []int{2}
}
...
func (*ExampleParserConfiguration) Descriptor() ([]byte, []int) {
	return fileDescriptor_example_parser_configuration_062c9db71589bcea, []int{3}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/example/example_parser_configuration.proto", fileDescriptor_example_parser_configuration_062c9db71589bcea)
}

var fileDescriptor_example_parser_configuration_062c9db71589bcea = []byte{
