...
func (*TensorSliceProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_slice_402fec1469d8bb04, []int{0}
}
...
func (*TensorSliceProto_Extent) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_slice_402fec1469d8bb04, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_slice.proto", fileDescriptor_tensor_slice_402fec1469d8bb04)
}

var fileDescriptor_tensor_slice_402fec1469d8bb04 = []byte{
