...
func (*AllocationDescription) Descriptor() ([]byte, []int) {
	return fileDescriptor_allocation_description_c3f560ff24fa8621, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/allocation_description.proto", fileDescriptor_allocation_description_c3f560ff24fa8621)
}

var fileDescriptor_allocation_description_c3f560ff24fa8621 = []byte{
