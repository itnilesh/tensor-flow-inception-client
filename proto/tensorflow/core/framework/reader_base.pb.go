...
func (*ReaderBaseState) Descriptor() ([]byte, []int) {
	return fileDescriptor_reader_base_cbfa552638cf8051, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/reader_base.proto", fileDescriptor_reader_base_cbfa552638cf8051)
}

var fileDescriptor_reader_base_cbfa552638cf8051 = []byte{
