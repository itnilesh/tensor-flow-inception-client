...
func (*GraphDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_graph_13854f8f94ae334b, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/graph.proto", fileDescriptor_graph_13854f8f94ae334b)
}

var fileDescriptor_graph_13854f8f94ae334b = []byte{
