...
func (*MemoryLogStep) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_fa5024f3f7065da9, []int{0}
}
...
func (*MemoryLogTensorAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_fa5024f3f7065da9, []int{1}
}
...
func (*MemoryLogTensorDeallocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_fa5024f3f7065da9, []int{2}
}
...
func (*MemoryLogTensorOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_fa5024f3f7065da9, []int{3}
}
...
func (*MemoryLogRawAllocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_fa5024f3f7065da9, []int{4}
}
...
func (*MemoryLogRawDeallocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_memory_fa5024f3f7065da9, []int{5}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/log_memory.proto", fileDescriptor_log_memory_fa5024f3f7065da9)
}

var fileDescriptor_log_memory_fa5024f3f7065da9 = []byte{
