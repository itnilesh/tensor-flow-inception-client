...
func (*KernelDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_kernel_def_106ea25f146fdd94, []int{0}
}
...
func (*KernelDef_AttrConstraint) Descriptor() ([]byte, []int) {
	return fileDescriptor_kernel_def_106ea25f146fdd94, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/kernel_def.proto", fileDescriptor_kernel_def_106ea25f146fdd94)
}

var fileDescriptor_kernel_def_106ea25f146fdd94 = []byte{
