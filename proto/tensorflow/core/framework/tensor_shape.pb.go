...
func (*TensorShapeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_shape_eac7f5a8c4940899, []int{0}
}
...
func (*TensorShapeProto_Dim) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_shape_eac7f5a8c4940899, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_shape.proto", fileDescriptor_tensor_shape_eac7f5a8c4940899)
}

var fileDescriptor_tensor_shape_eac7f5a8c4940899 = []byte{
