...
func (RemoteFusedGraphExecuteInfo_NodeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_remote_fused_graph_execute_info_ee451000ec4b52b7, []int{0, 0}
}
...
func (*RemoteFusedGraphExecuteInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_remote_fused_graph_execute_info_ee451000ec4b52b7, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/remote_fused_graph_execute_info.proto", fileDescriptor_remote_fused_graph_execute_info_ee451000ec4b52b7)
}

var fileDescriptor_remote_fused_graph_execute_info_ee451000ec4b52b7 = []byte{
