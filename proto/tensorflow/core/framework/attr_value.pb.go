...
func (*AttrValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_attr_value_fd3f337ee89868f7, []int{0}
}
...
func (*AttrValue_ListValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_attr_value_fd3f337ee89868f7, []int{0, 0}
}
...
func (*NameAttrList) Descriptor() ([]byte, []int) {
	return fileDescriptor_attr_value_fd3f337ee89868f7, []int{1}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/attr_value.proto", fileDescriptor_attr_value_fd3f337ee89868f7)
}

var fileDescriptor_attr_value_fd3f337ee89868f7 = []byte{
