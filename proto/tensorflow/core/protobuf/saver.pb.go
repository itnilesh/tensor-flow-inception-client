...
func (SaverDef_CheckpointFormatVersion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_saver_1a57971e9d8b6f51, []int{0, 0}
}
...
func (*SaverDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_saver_1a57971e9d8b6f51, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/saver.proto", fileDescriptor_saver_1a57971e9d8b6f51)
}

var fileDescriptor_saver_1a57971e9d8b6f51 = []byte{
