...
func (ModelVersionStatus_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_get_model_status_984607cd194f3570, []int{1, 0}
}
...
func (*GetModelStatusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_status_984607cd194f3570, []int{0}
}
...
func (*ModelVersionStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_status_984607cd194f3570, []int{1}
}
...
func (*GetModelStatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_get_model_status_984607cd194f3570, []int{2}
}
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/get_model_status.proto", fileDescriptor_get_model_status_984607cd194f3570)
}

var fileDescriptor_get_model_status_984607cd194f3570 = []byte{
